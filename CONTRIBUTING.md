# Contributing to Llama Personalization

Thank you for your interest in contributing to Llama Personalization! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Personalization:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-personalization.git
   cd llama-personalization
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-personalization.git
   ```
...
By contributing to Llama Personalization, you agree that your contributions will be licensed under the project's MIT License.
